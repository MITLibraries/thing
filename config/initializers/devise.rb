...
Devise.setup do |config|
  ...
  if Rails.configuration.fake_auth_enabled
    ...
    config.omniauth :saml,
                    ...
                    security: { authn_requests_signed: ENV['DEBUG_ARS'],
                                want_assertions_signed: ENV['DEBUG_WAS'],
                                want_assertions_encrypted: ENV['DEBUG_WAE'],
                                metadata_signed: ENV['DEBUG_MS'],
                                embed_sign: ENV['DEBUG_ES'],
