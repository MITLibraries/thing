...
Devise.setup do |config|
  ...
  if Rails.configuration.fake_auth_enabled
    ...
    config.omniauth :saml,
                    ...
                    certificate: Base64.strict_decode64(ENV.fetch('SP_CERTIFICATE', '')),
                    private_key: Base64.strict_decode64(ENV.fetch('SP_PRIVATE_KEY', '')),
                    ...
                    attribute_statements: { uid: [ENV['URN_UID']],
                                            ...
                                            display_name: [ENV['URN_DISPLAY_NAME']] },
